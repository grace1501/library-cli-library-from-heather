...
class TestLibrary < Minitest::Test
  ...
  def test_book
    @book1 = Book.new("The Great Gatsby", "F. Scott Fitzgerald", "Fiction")
    assert_equal('Fiction The Great Gatsby by F. Scott Fitzgerald', @book1.to_s, "Book class to_s method fail")
  end

  def test_library
    library = Library.new
    assert_kind_of(Array, library.books, "Initialize library method failed")
  end
